...
const ReceptionSignup = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const emailExists = existingReceptionists.find(
    ...
    <div className="min-h-screen flex flex-col justify-center items-center py-4 md:py-10 relative">
      ...
      <main className="w-full max-w-xl flex flex-col items-center gap-10 relative z-10">
        <div className="inline-flex items-center gap-3 px-6 py-3 bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-white/50 mt-16 md:mt-0">
          ...
          <span className="font-semibold text-xl">Reception Signup</span>
        </div>

        <div className="flex flex-col items-center text-center gap-4">
          <h1 className="text-5xl md:text-6xl font-bold">Join Reception</h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Create your reception account to manage visitors and handle front
            desk operations
          </p>
        </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Your reception account will be secured with enterprise-grade
                  encryption. All registration attempts are monitored and logged
