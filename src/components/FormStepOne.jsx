  ...
  return (
    <div className="space-y-8">
      <div className="text-center space-y-3 max-w-xl mx-auto">
        <div className="inline-flex items-center gap-2 px-4 py-2 mb-6 bg-gradient-to-r from-orange-100 to-red-100 rounded-full border border-orange-200">
        ...
        <p className="text-sm md:text-xl text-slate-600 mx-auto leading-relaxed">
          Please provide details about your host and when you'd like to schedule
          your visit
        </p>
      </div>

      <form type="submit" className="flex flex-col gap-6">
        <InputField
          name="hostName"
      ...
      <div className="mt-8 p-4 bg-gray-50/80 rounded-2xl border border-gray-200">
        <div className="flex items-start gap-4">
          <div className="space-y-2">
            <div className="flex gap-2 items-center">
              <FiShield size={18} className="text-orange-500 flex-shrink-0" />
